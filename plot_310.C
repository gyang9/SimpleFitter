...
//cout<<"here2"<<endl;
//if(ddd > lineS1[sss] && ddd<200 && ddd> 0.1) { lineS1[sss]=ddd; }
//if(ddd > lineS2[aaa] && ddd<200 && ddd> 0.1) { lineS2[aaa]=ddd; }
//if(ddd > lineS3[bbb] && ddd<200 && ddd> 0.1) { lineS3[bbb]=ddd; }
//if(ddd > lineS4[ccc] && ddd<200 && ddd> 0.1) { lineS4[ccc]=ddd; }
//cout<<"here"<<endl;
}
in.close();
...
TGraphErrors *gr23 = new TGraphErrors(10,bin_x,line4,0,0);
...
leg->AddEntry(gr21, "FD channel-channel", "l ");
leg->AddEntry(gr22, "ND channel-channel", " l");
...
TGraphErrors *gr23 = new TGraphErrors(10,bin_x,lineS4,0,0);
